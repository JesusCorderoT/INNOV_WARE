...
function peticionbuscarProductoNombreUser() {
    ...
    //alert("Titulo antes de get");
    xhr.open("GET", "fffffffff?nombre_producto=" + nombre_producto, true);
    //xhr.open("GET", "Pruebas", true);
...
function peticionformAgregarPendiente(id_Pro, nombre, descr, costo) {
    ...
    //   alert(id_producto);
    //alert("Titulo antes de get");
    xhr.open("GET", "Form_Agregar_Pendiente_BUENO?id_user=" + id_producto + "&nombre_producto=" + nombre_producto + "&descripcion=" + descripcion + "&costo=" + costo_Producto, true);
    //xhr.open("GET", "Pruebas", true);
...
function peticionañadirListaPendiente() {
    ...
    //   alert(id_usuario);
    xhr.open("GET", "Agregar_Lista_Pendiente_BUENO?id_producto=" + id_producto + "&nombre_producto=" + nombre_producto + "&costo=" + costo + "&iduser=" + id_usuario, true);
...
function peticionformularioAgregarPendiente(id_Pro, nombre, descr, costo) {
    ...
    //xhr.open("GET", "Pruebas", true);
    xhr.onreadystatechange = verificarformularioAgregarPendiente;
    //alert("Elemento verificado");
    xhr.send(null);
}
...
function formProblemaProducto(id) {
    // alert("objeto");
    var id_pro = id;
    createObjeto();
    peticionformProblemaProducto(id_pro);

}

function peticionformProblemaProducto(id_prod) {
    var id_producto = id_prod;
    // var totalCotizacion = document.getElementById("totalCoti").value;
    // var fecha = document.getElementById("fecha").value;
    // var id_cliente = document.getElementById("id_cliente").value;
    ...
    xhr.open("GET", "Form_Problema_Producto?id_producto=" + id_producto, true);

    xhr.onreadystatechange = verificarformProblemaProducto;
    //alert("Elemento verificado");
    xhr.send(null);
}

function verificarformProblemaProducto() {
    //alert("Verificacion");
    if (xhr.readyState === 4) {
        document.getElementById("RespuestaMasOpciones2").innerHTML = "<em>" + xhr.responseText + "</em>";
    }
...
function problemaProducto(id) {
    // alert("objeto");
    createObjeto();
    var aidi = id;
    peticionproblemaProducto(aidi);

}

function peticionproblemaProducto(aidi) {
    var id_producto = aidi;
    var descripcion = document.getElementById("problema_producto").value;
    // var fecha = document.getElementById("fecha").value;
    var id_producto = aidi;
    ...
    //alert(id_cliente);
    //alert("xD");
    xhr.open("GET", "Problema_Producto?id_producto=" + id_producto + "&descripcion=" + descripcion, true);

    xhr.onreadystatechange = verificarproblemaProducto;
    //alert("Elemento verificado");
    xhr.send(null);
}

function verificarproblemaProducto() {
    //alert("Verificacion");
    if (xhr.readyState === 4) {
        document.getElementById("AnswerProblemaProducto").innerHTML = "<em>" + xhr.responseText + "</em>";
    }
}
...
function MostrarListaCotizaciones() {
    ...
    createObjeto();
    //var aidi = id;
    peticionMostrarListaCotizaciones();
}

function peticionMostrarListaCotizaciones(aidi) {
    // var id_producto = aidi;
    //var descripcion = document.getElementById("problema_producto").value;
    // var fecha = document.getElementById("fecha").value;
    // var id_producto = aidi;
    ...
    //alert(id_cliente);
    // alert("xD");
    xhr.open("GET", "Mostrar_Lista_Cotizaciones", true);

    xhr.onreadystatechange = verificarMostrarListaCotizaciones;
    //alert("Elemento verificado");
    xhr.send(null);
}

function verificarMostrarListaCotizaciones() {
    if (xhr.readyState === 4) {
        document.getElementById("RespuestaTodosLosProcudtos").innerHTML = "<em>" + xhr.responseText + "</em>";
    }
}
...
function MostrarListaPendientes() {
    ...
    createObjeto();
    //var aidi = id;
    peticionMostrarListaPendientes();
}

function peticionMostrarListaPendientes() {
    // var id_producto = aidi;
    //var descripcion = document.getElementById("problema_producto").value;
    // var fecha = document.getElementById("fecha").value;
    // var id_producto = aidi;
    ...
    //alert(id_cliente);
    // alert("xD");
    xhr.open("GET", "Mostrar_Lista_Pendientes", true);

    xhr.onreadystatechange = verificarMostrarListaPendientes;
    //alert("Elemento verificado");
    xhr.send(null);
}

function verificarMostrarListaPendientes() {
    if (xhr.readyState === 4) {
        document.getElementById("RespuestaTodosLosProcudtos").innerHTML = "<em>" + xhr.responseText + "</em>";
    }
}
