 ...
 * @author Lab-CB08
 */
@WebServlet(name = "FiltrarFecha", urlPatterns = {"/FiltrarFecha"})
...
ResultSet cdr = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FiltrarFecha</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FiltrarFecha at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
          String fecha = request.getParameter("fecha");
            String comando = "select folio,nombre_completo,asunto,fecha,estado from agenda where fecha='" + fecha + "' and estado='pendiente';";
            try {
                ...
                while (cdr.next()) {
                    ...
                    out.println("<td width=10%><input type=\"submit\" id=\"modi\" value=\"Modificar\" onclick=\"modificarAD()\"></td>");
                    out.println("</tr>");
