 ...
 * @author jesus
 */
@WebServlet(name = "Buscar_Producto_Por_Nombre_Usuario_1", urlPatterns = {"/Buscar_Producto_Por_Nombre_Usuario_1"})
public class Buscar_Producto_Por_Nombre_Usuario_1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Buscar_Producto_Por_Nombre_Usuario_1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Buscar_Producto_Por_Nombre_Usuario_1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println(" <th>Producto</th> <th>Descripci&oacute;n</th>   <th>Pendiente:v</th> <th>Más información</th> <th>¿Quieres calificar el producto?</th> <th>Mostrar calificación del producto</th> ");
            out.println("</tr>");
            while (cdr.next()) {
                ...
                out.println("<td width=10%><input type=\"button\" name=\"Problemas_producto\" id=\"Problemas_producto\" value=\"Reportar Producto'\" onclick=\"formAgregarPendiente(" + cdr.getString(1) + ");\"></td>");
