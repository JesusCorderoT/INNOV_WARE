 ...
 * @author jorge
 */
@WebServlet(name = "Form_Registrar_Productos1", urlPatterns = {"/Form_Registrar_Productos1"})
public class form_Registrar_Productos2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Form_Registrar_Productos1</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Form_Registrar_Productos1 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<legend><h2>Registrar un producto :v</h2></legend>");
            out.println("<p> Nombre del nuevo producto </p>");
