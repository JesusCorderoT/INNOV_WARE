 ...
 * @author jorge
 */
@WebServlet(name = "Form_Agregar_Pendiente_BUENO", urlPatterns = {"/Form_Agregar_Pendiente_BUENO"})
public class Form_Agregar_Pendiente_BUENO extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /*try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Form_Agregar_Pendiente_BUENO</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Form_Agregar_Pendiente_BUENO at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }*/
    }
