 ...
 * @author carlos toto
 */
@WebServlet(name = "ConsultarcitaDatos", urlPatterns = {"/ConsultarcitaDatos"})
public class ConsultarcitaDatos extends HttpServlet {
ResultSet cdr = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConsultarcitaDatos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConsultarcitaDatos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
        ...
        try {
            ...
            if(cdr.next()){
              ...
              while(cdr.next()){
                ...
                out.println("Estado:<input type=\"text\" readonly value="+cdr.getString(7)+"><br>");
            }
            }else{
