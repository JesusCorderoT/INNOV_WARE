 ...
 * @author carlos toto
 */
@WebServlet(name = "ModificarcitaDatos", urlPatterns = {"/ModificarcitaDatos"})
public class ModificarcitaDatos extends HttpServlet {
ResultSet cdr = null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModificarcitaDatos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ModificarcitaDatos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
        ...
        try {
            ...
            if(cdr.next()){
              ...
              while(cdr.next()){
                ...
                out.println(" Fecha:<input type=\"date\" id=\"fecha\" name=\"fecha\"  value="+cdr.getString(5)+"><br>");
                out.println("Hora:<input type=\"time\" id=\"hora\" name=\"hora\" readonly value="+cdr.getString(6)+"><br>");
                
            }
              out.println("<input type=\"submit\" value=\"Modificar\" onclick=\"modificarcitasql()\"><br>");
              out.println("<p id=respmodatos></p>");
            }else{
