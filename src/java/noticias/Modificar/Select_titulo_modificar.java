 ...
 * @author brandon
 */
@WebServlet(name = "Select_titulo_modificar", urlPatterns = {"/Select_titulo_modificar"})
public class Select_titulo_modificar extends HttpServlet {
ResultSet cdr = null;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            out.println("<label>Selecciona titulo para modificar</label>");
            out.println("<select id='select'  onchange=\"mostrar_formulario_modificable()\" >");
