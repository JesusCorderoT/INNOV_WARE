    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        try {
           ...
           if(nombre=="" || apellidos=="" ||telefono=="" || usuario=="" || contrasena=="" || genero=="" ){
            ...
            co.enviarcorreo(c);
              ...
              String strComando = "insert into usuario(nombre, apellidos, telefono, usuario, contrasena, genero, correo_electronico, codigo_verificacion, nivel, estado,correo_enviado) values('"+nombre+"','"+apellidos+"', '"+telefono+"', '"+usuario+"', '"+contrasena+"','"+genero+"','"+correo_electronico + dominio+"','"+codigo+"',"+nivel+",'"+es+"','"+envio+"');";  
            ...
            int cdr = sentenciaSQL.executeUpdate(strComando);  
             if(cdr==1){
               ...
               out.println("<br><br>");
               out.println("<input type=\"button\" value=\"verificar\" onclick=\"mostrar_formulario_verificacion()\">");
           }else{
