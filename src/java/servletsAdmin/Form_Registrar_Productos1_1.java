...
public class Form_Registrar_Productos1_1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<legend><h2>Registrar un productossss :v</h2></legend>");
            out.println("<p> Nombre del nuevo producto sssss </p>");
