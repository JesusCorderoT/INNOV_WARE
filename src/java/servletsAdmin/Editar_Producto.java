...
public class Editar_Producto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String comando = "Update productos set nombre_producto = ' "+nombre_producto+" ' , descripcion='"+descripcion+"', costo= "+costo+" , imagen_producto= '"+imagen+"', existencia_producto = 'Si' where id_producto= "+id_producto+";";

        try {
            if (sentenciaSQL.executeUpdate(comando)==1) {
                out.println("El producto se ha modificado con exito");
            }
        } catch (Exception e) {
            out.println("Ha surgido un error al modificar el producto");
        }
    }
