 ...
 * @author jorge
 */
@WebServlet(name = "Mostrar_Lista_Cotizaciones", urlPatterns = {"/Mostrar_Lista_Cotizaciones"})
public class Mostrar_Lista_Cotizaciones extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /*try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Mostrar_Lista_Cotizaciones</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Mostrar_Lista_Cotizaciones at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }*/
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String strComando = "Select * from cotizaciones;";
            cdr = sentenciaSQL.executeQuery(strComando);

            out.println("<table width=100% border=1>");
            out.println("<tr>");

            out.println("<th>ID Cotización</th> <th>Descricpicon de los productos</th> <th>Total</th> <th>Fecha</th> <th>Usuario</th> ");
            out.println("</tr>");
            while (cdr.next()) {
