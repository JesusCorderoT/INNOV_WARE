 ...
 * @author Darkam
 */
@WebServlet(name = "Mostrar_Todos_Los_Productos", urlPatterns = {"/Mostrar_Todos_Los_Productos"})
public class Mostrar_Todos_Los_Productos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        /* try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Mostrar_Todos_Los_Productos</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Mostrar_Todos_Los_Productos at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }*/
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String strComando = "Select * from productos;";
            cdr = sentenciaSQL.executeQuery(strComando);

            out.println("<table width=100% border=1>");
            out.println("<tr>");

            out.println("<th>ID Producto</th> <th>Producto</th> <th>Descripci&oacute;n</th> <th>Costo</th> <th>Eliminar</th> <th>Editar</th> <th>Más opciones</th>");
            out.println("</tr>");
            while (cdr.next()) {
