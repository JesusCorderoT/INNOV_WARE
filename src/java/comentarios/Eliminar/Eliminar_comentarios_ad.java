 ...
 * @author brandon
 */
@WebServlet(name = "Eliminar_comentarios_ad", urlPatterns = {"/Eliminar_comentarios_ad"})
public class Eliminar_comentarios_ad extends HttpServlet {
ResultSet cdr = null;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (validado.equals(val)) {
                String strComando = "DELETE FROM comentario where usuario='" + id_comentario + "';";
