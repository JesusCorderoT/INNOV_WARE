 ...
 * @author alvar
 */
@WebServlet(urlPatterns = {"/BusquedaDescripcionPalabraCliente"})
public class BusquedaDescripcionPalabraCliente extends HttpServlet {
ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BusquedaDescripcionPalabraCliente</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BusquedaDescripcionPalabraCliente at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
