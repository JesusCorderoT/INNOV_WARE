 ...
 * @author alvar
 */
@WebServlet(urlPatterns = {"/calificarServicio"})
public class calificarServicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet calificarServicio</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet calificarServicio at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        sentenciaSQL.executeUpdate(registrar);
            out.println("El servicio se califico correctamente");
