 ...
 * @author alvar
 */
@WebServlet(name = "MostrarServiciosCliente", urlPatterns = {"/MostrarServiciosCliente"})
public class MostrarServiciosCliente extends HttpServlet {
ResultSet cdr=null;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MostrarServiciosCliente</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MostrarServiciosCliente at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<tr>");
            out.println("<th>ID servicio</th>" + "<th>Nombre servicio</th>" + "<th>Costo</th>" + "<th>Categoria</th>");
            out.println("</tr>");
